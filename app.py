...
def admindashboard():
    ...
    if is_admin:
        ...
        alladmin = User.query.all()
        return render_template("admindashboard.html",alltodo=alltodo, alluser=alluser, alladmin=alladmin)
    else:
        
        return render_template("try_again.html",message = "You are not a Admin ! Sorry")
